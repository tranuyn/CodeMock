...
const sampleInterviews = [
  {
    ...
    description: 'Front-end Developer, Master in ReactJs, Javascript, Typescript, html, css, bootstrap, sql basic',
...
export default function Home() {
  ...
  const [filteredInterviews, setFilteredInterviews] = useState(sampleInterviews);
...
const handleSearch: HandleSearch = (query) => {
    ...
    if (query.trim() === '') {
        ...
        const filtered = sampleInterviews.filter((interview: Interview) => 
  ...
  return (
    <ThemeProvider theme={theme}>
      <Head>
        <title>Danh sách phỏng vấn</title>
        <meta name="description" content="Tìm kiếm và đăng ký phỏng vấn" />
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Grid container spacing={3}>
          ...
          <ListItem><FilterSection /></ListItem>
          </Grid>
